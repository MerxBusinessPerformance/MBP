...
class MailActivity(models.Model):
    ...
    overdue_time = fields.Char(string='Dias de atraso', compute="overdue_days")

    def overdue_days(self):
        for line in self:
            if line.state == 'done':
                line.overdue_time = str(line.date_done - line.date_deadline)
            else:
                line.overdue_time = str(fields.Date.today() - line.date_deadline)
