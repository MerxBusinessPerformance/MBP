odoo.define('emipro_theme_base.load_more', function(require) {
    ...
    sAnimations.registry.loadMore = sAnimations.Animation.extend({
        ...
        variantHoverLoadMore: function() {
            var AjaxColorPane = new publicWidget.registry.AjaxColorPane();
            $('.te_cv_sp').mouseenter(function(event) {
                AjaxColorPane._onMouseEnterColorHover(event);
            });
            $('.te_cv_sp').mouseleave(function(event) {
                AjaxColorPane._onMouseEnterColorHoverOut(event);
            });
        },
